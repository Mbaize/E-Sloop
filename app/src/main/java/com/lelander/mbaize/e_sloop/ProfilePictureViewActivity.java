...
import com.lelander.mbaize.e_sloop.util.SystemUiHider;
...
public class ProfilePictureViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        fullProfilePicture = i.getStringExtra("boatImage");
        Toast.makeText(this, fullProfilePicture, Toast.LENGTH_LONG).show();
        ...
        imageLoader.DisplayImage(fullProfilePicture, imgboat);
        ...
        // this activity.
        mSystemUiHider = SystemUiHider.getInstance(this, imgboat, HIDER_FLAGS);
        ...
        //(REMOVED) findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
    }
