 ...
 */
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor>, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<People.LoadPeopleResult> {
            ...
            mPlusSignInButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!mGoogleApiClient.isConnected()){
                        Toast.makeText(LoginActivity.this, "apiclient not connected", Toast.LENGTH_LONG).show();
                    }
                    else {
                        signIn();
                    }
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        //The "if block" below seems unnecessary since we're in the onConnected method. But, if it's not included, a Nullpointer exception is returned
        if (!mGoogleApiClient.isConnected()) {
